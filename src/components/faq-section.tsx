...
export function FAQSection() {
  ...
  return (
    <>
      <Head>
        <title>AI SEO Tool FAQ – Get Answers About AI Visibility</title>
        <meta name="description" content="Frequently asked questions about AI SEO, ChatGPT visibility, robots.txt, and how to make your website discoverable by AI systems." />
        <meta property="og:title" content="AI SEO Tool FAQ – Get Answers About AI Visibility" />
        <meta property="og:description" content="Frequently asked questions about AI SEO, ChatGPT visibility, robots.txt, and how to make your website discoverable by AI systems." />
        <meta property="og:image" content="https://amivisibleonai.vercel.app/og-image.png" />
        <meta property="og:url" content="https://amivisibleonai.vercel.app/#faq" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="AI SEO Tool FAQ – Get Answers About AI Visibility" />
        <meta name="twitter:description" content="Frequently asked questions about AI SEO, ChatGPT visibility, robots.txt, and how to make your website discoverable by AI systems." />
